...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x6001_hardwareVersion = {'1', '.', '1', 0},
    .x6002_softwareVersion = {'2', '.', '2', 0},
    .x6003_hardwareId = {'A', 'B', 'C', '1', '2', '3', 0}
};
...
typedef struct {
    ...
    OD_obj_var_t o_6001_hardwareVersion;
    OD_obj_var_t o_6002_softwareVersion;
    OD_obj_var_t o_6003_hardwareId;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6001_hardwareVersion = {
        .dataOrig = &OD_RAM.x6001_hardwareVersion[0],
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_STR,
        .dataLength = 3
    },
    .o_6002_softwareVersion = {
        .dataOrig = &OD_RAM.x6002_softwareVersion[0],
        .attribute = ODA_SDO_RW | ODA_STR,
        .dataLength = 3
    },
    .o_6003_hardwareId = {
        .dataOrig = &OD_RAM.x6003_hardwareId[0],
        .attribute = ODA_SDO_RW | ODA_STR,
        .dataLength = 6
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_hardwareVersion, NULL},
    {0x6002, 0x01, ODT_VAR, &ODObjs.o_6002_softwareVersion, NULL},
    {0x6003, 0x01, ODT_VAR, &ODObjs.o_6003_hardwareId, NULL},
